...
# 📖 React Weather API <a name="about-project"></a>

A weather app to retrieve data from API and display the data in real time using Socket.io.

## 🚀 FrontEnd <a name="back-end"></a>

 [Click here to see the weather-app](https://github.com/rubydevi/react-weather-app)
...
> Get weather details of the Coordinates
...
Feel free to check the [issues page](https://github.com/rubydevi/react-weather-api/issues).
